...
public abstract class Paginate {
     ...
     * Create pagination functionality upon RecyclerView.
     *
     * @param nestedScrollView NestedScrollView that hold the RecyclerView with pagination functionality.
     * @param callback     pagination callbacks.
     * @return {@link com.paginate.recycler.RecyclerPaginate.Builder}
     */
    public static RecyclerPaginate.Builder with(NestedScrollView nestedScrollView,RecyclerView recyclerView, Callbacks callback) {
        return new RecyclerPaginate.Builder(nestedScrollView,recyclerView, callback);
    }
